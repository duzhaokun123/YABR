...
import io.github.duzhaokun123.yabr.core.R as CoreR
...
object WindowBlur : BaseModule(), UISwitch, SwitchModule, Compatible {
    ...
    fun hookDialog(): Boolean {
        Dialog::class.java
            ...
            .hookAfter {
                ...
                window.apply {
                    ...
                    val background = ContextCompat.getDrawable(dialog.context, CoreR.drawable.dialog_background)!!
        ...
        Dialog::class.java
            ...
            .hookBefore {
                val newThemeId = CoreR.style.AppTheme_Dialog
